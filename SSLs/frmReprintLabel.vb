Public Class frmReprintLabel

    Public dt As New List(Of RcvHeader)

    Private Sub frmReprintLabel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SelData()
    End Sub
    ...
    Sub SelData()
        Try
            ...
            Using db = New PTGwmsEntities
                ...
                Else
                    Dim Rcv = db.RcvDetails.Where(Function(x) x.RcvHeader.FKCompany = CompID And x.RcvHeader.ConfirmDate IsNot Nothing And x.Enable = True And frmMain.ow.Contains(x.RcvHeader.Owners.Code.ToString) And frmMain.wh.Contains(x.Warehouse.Code.ToString)).ToList
