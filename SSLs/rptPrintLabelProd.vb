...
Public Class rptPrintLabelProd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMs.rptPrintLabelProd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintLabelProd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintLabelProd = New rptPrintLabelProd()
        rpt.Site = Me.Site
        Return rpt
    End Function
