...
Partial Public Class ChangeSalesOrderDetails
    ...
    Public Property FKChangeSalesOrder As Integer
    Public Property WMsWH As String
    Public Property Func As String
    Public Property ItemCate As String

    Public Overridable Property ChangeSalesOrder As ChangeSalesOrder
