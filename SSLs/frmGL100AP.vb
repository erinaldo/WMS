...
Public Class frmGL100AP

    Private Sub frmGL100AP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub SelData()
        Try
            ...
            Using db = New PTGwmsEntities
                Dim dt = db.V_GL100AP.Where(Function(x) x.TransDate >= DateFrom And x.TransDate <= DateTo).ToList
                If dt.Count > 0 Then
    ...
    Private Sub btExcel_Click(sender As System.Object, e As System.EventArgs) Handles btExcel.Click
        ...
        xlApp.ActiveSheet.Cells(1, 1) = "REPORT GL100AP"
