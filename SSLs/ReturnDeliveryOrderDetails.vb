...
Partial Public Class ReturnDeliveryOrderDetails
    ...
    Public Property FKReturnDeliveryOrder As Integer
    ...
    Public Overridable Property ReturnDeliveryOrder As ReturnDeliveryOrder
