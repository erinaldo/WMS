...
Public Class frmStockLocation
    ...
    Sub SelData()
        Try
            ...
            Using db = New PTGwmsEntities
                ...
                If RoleID = 1 Then
                    dt = db.V_StockLocation.Where(Function(x) x.FKCompany = CompID And x.FKWarehouse = intWh).ToList
                Else
                    dt = db.V_StockLocation.Where(Function(x) x.FKCompany = CompID And x.FKWarehouse = intWh And frmMain.ow.Contains(x.OwnCode.ToString) And frmMain.wh.Contains(x.WHCode.ToString)).ToList
                End If
    ...
    Private Sub SumGrid()
        ...
        For index As Integer = 0 To DataGridView1.RowCount - 1
            qty += Convert.ToDecimal(DataGridView1.Rows(index).Cells(13).Value)
            bookQty += Convert.ToDecimal(DataGridView1.Rows(index).Cells(14).Value)
        Next
    ...
    Private Sub btExcel_Click(sender As System.Object, e As System.EventArgs) Handles btExcel.Click
        ...
        xlApp.ActiveSheet.Cells(1, 1) = "รายงานสต็อก Location"
    ...
    Private Sub frmStockLocation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
