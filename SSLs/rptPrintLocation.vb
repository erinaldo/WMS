...
Public Class rptPrintLocation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WMs.rptPrintLocation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintLocation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintLocation = New rptPrintLocation()
        rpt.Site = Me.Site
        Return rpt
    End Function
